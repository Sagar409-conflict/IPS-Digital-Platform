...
class SendPendingApprovaltemplate {
            ...
            <td>
              ...
              <div style="font-weight:normal;padding:0px 24px 4px 24px">
                ...
                <p>
                  ...
                  all future pending event submissions by organizers.
                </p>
...
const SendPendingApprovalaTemplate = new SendPendingApprovaltemplate()
export default SendPendingApprovalaTemplate
