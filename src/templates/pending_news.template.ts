import { ISendApprovalemail } from '../types/mail_template.interface'

class SendApprovaltemplate {
  sendApprovalEmail(body: ISendApprovalemail) {
    return `<!doctype html>
<!doctype html>
<html>
  <body>
    ...
    >
      ...
      body.admin_last_name
              ...
              <div style="font-weight:normal;padding:0px 24px 4px 24px">
                <p>
                  Please review the pending news item and take the necessary
                ...
                <p>
                  ...
                  all future pending news submissions by organizers.
                </p>
...
const SendApprovalaTemplate = new SendApprovaltemplate()
export default SendApprovalaTemplate
